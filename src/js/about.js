...
export const about = `
    ...
    <img src="./assets/img/LinkedIn Banner Máster en  Educación Rojo y Azul.png" alt="Mi familia" class="w-100 w-md-75 m-auto mt-5 shadow-lg rounded">
